import {
  ACT_COMMANDS, ANALYZE_COMMANDS, COMMAND_SYS_CONTINUE, TRANSLATE_COMMANDS, TYPE_TRANSLATING,
...
const exec = (context) => check(context) && (
  async () => {
    ...
    const reference = command.type === TYPE_TRANSLATING ? history.lastRecord.text : history.toString();
