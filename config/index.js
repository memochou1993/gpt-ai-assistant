...
export const OPENAI_COMPLETION_TEMPERATURE = Number(env.OPENAI_COMPLETION_TEMPERATURE) || 0.9;
export const OPENAI_COMPLETION_MAX_TOKENS = Number(env.OPENAI_COMPLETION_MAX_TOKENS) || 240;
export const OPENAI_COMPLETION_FREQUENCY_PENALTY = Number(env.OPENAI_COMPLETION_FREQUENCY_PENALTY) || 0;
export const OPENAI_COMPLETION_PRESENCE_PENALTY = Number(env.OPENAI_COMPLETION_PRESENCE_PENALTY) || 0.6;
